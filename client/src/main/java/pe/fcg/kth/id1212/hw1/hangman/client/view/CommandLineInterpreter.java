package pe.fcg.kth.id1212.hw1.hangman.client.view;

import pe.fcg.kth.id1212.hw1.hangman.client.controller.Controller;
import pe.fcg.kth.id1212.hw1.hangman.client.controller.GameStateMessage;
...
public class CommandLineInterpreter implements Runnable, RawMessageHandler {
    ...
    public void handleLostConnection() {
        ...
        printWithoutPrompt("Failure to receive message from server.");
    }
}
