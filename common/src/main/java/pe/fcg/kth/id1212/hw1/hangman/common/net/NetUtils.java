package pe.fcg.kth.id1212.hw1.hangman.common.net;
    ...
    public static String receiveMessage(InputStream inputStream) throws IOException {
        ...
        while(messageLengthBytesRead < SIZE_OF_INT) {
            ...
            if(messageLengthBytesRead > SIZE_OF_INT) {
                ...
                idx = 0;
                System.out.println("message length bytes read = " + messageLengthBytesRead);
                System.out.println("needed bytes = " + neededBytes);
